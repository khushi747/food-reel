...
const BottomNav = ({ profileId }) => {
  const { user } = useUser();
  const role = user?.role;
  const profilePath =
    role == "foodPartner"
      ? `/food-partner-profile/${profileId}`
